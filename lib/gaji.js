...
// sesuai PANGKAT_LIST (app.js/lib/pangkat.js). Ajun Brigadir Polisi,
...
// Jendela pengambilan gaji: HANYA Senin(1)–Rabu(3). Kalau lewat Rabu tanpa
// diklaim, jatah minggu itu hangus — nggak bisa diambil susulan di Kamis-Minggu,
// dan minggu berikutnya mulai dari nol lagi (bukan akumulasi).
function bisaKlaimHariIni(d = new Date()) {
...
module.exports = {
  TABEL_GAJI, getGajiPangkat, getMondayISO, sudahKlaimMingguIni, bisaKlaimHariIni, klaimGaji,
};
